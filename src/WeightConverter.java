...
public class WeightConverter extends JFrame implements ActionListener, MouseListener, DocumentListener{
	...
	String[] textFieldOptions = {"Miligrams", "Grams", "Kilograms", "Pounds", "Metric tonnes"};
	static double num1, num2, result;
	ImageIcon frameIcon = new ImageIcon("icon.png");
	JFrame weightConverterFrame = new JFrame("Weight Converter");

	WeightConverter(){
		weightConverterFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		weightConverterFrame.setSize(335, 545);
		weightConverterFrame.setLocationRelativeTo(null);
		weightConverterFrame.setLayout(new BorderLayout());
		weightConverterFrame.getContentPane().setBackground(new Color(27, 27, 27));
		weightConverterFrame.setIconImage(frameIcon.getImage());
		...
		weightConverterFrame.add(topPanel, BorderLayout.NORTH);
		weightConverterFrame.add(botPanel, BorderLayout.SOUTH);
		...
		weightConverterFrame.setVisible(true);
	}
