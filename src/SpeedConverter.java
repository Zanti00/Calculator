...
public class SpeedConverter extends JFrame implements ActionListener, MouseListener, DocumentListener{
	...
	String[] textFieldOptions = {"Kilometers per hour", "Miles per hour"};
	static double num1, num2, result;
	ImageIcon frameIcon = new ImageIcon("icon.png");
	JFrame speedConverterFrame = new JFrame("Speed Converter");

	SpeedConverter(){
		speedConverterFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		speedConverterFrame.setSize(335, 545);
		speedConverterFrame.setLocationRelativeTo(null);
		speedConverterFrame.setLayout(new BorderLayout());
		speedConverterFrame.getContentPane().setBackground(new Color(27, 27, 27));
		speedConverterFrame.setIconImage(frameIcon.getImage());
		...
		speedConverterFrame.add(topPanel, BorderLayout.NORTH);
		speedConverterFrame.add(botPanel, BorderLayout.SOUTH);
		
		option1 = new JComboBox<>(textFieldOptions);
		option1.addActionListener(this);
		option1.setBounds(10, 100, 150, 20);

		option2 = new JComboBox<>(textFieldOptions);
		option2.addActionListener(this);
		option2.setBounds(10, 210, 150, 20);
		...
		speedConverterFrame.setVisible(true);
	}
