...
public class TemperatureConverter extends JFrame implements ActionListener, MouseListener, DocumentListener{
	...
	JButton deciButton, delButton, clrButton, menu, signButton;
	...
	String[] textFieldOptions = {"Celsius", "Fahrenheit", "Kelvin"};
	static double num1, num2, result;
	ImageIcon frameIcon = new ImageIcon("icon.png");
	JFrame temperatureConverterFrame = new JFrame("Temperature Converter");

	TemperatureConverter(){
		temperatureConverterFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		temperatureConverterFrame.setSize(335, 545);
		temperatureConverterFrame.setLocationRelativeTo(null);
		temperatureConverterFrame.setLayout(new BorderLayout());
		temperatureConverterFrame.getContentPane().setBackground(new Color(27, 27, 27));
		temperatureConverterFrame.setIconImage(frameIcon.getImage());
		...
		temperatureConverterFrame.add(topPanel, BorderLayout.NORTH);
		temperatureConverterFrame.add(botPanel, BorderLayout.SOUTH);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == menu) {
			Menu menu = new Menu();
			temperatureConverterFrame.dispose();
		}
	}
	@Override
